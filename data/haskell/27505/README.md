...
**ID:** `c976d5ab` &nbsp;·&nbsp; **Signature:** `Error:panic! (the 'impossible' happened)_L1817` &nbsp;·&nbsp; **RC:** `1`
...
<no location info>: error:
  ...
  Call stack:
      CallStack (from HasCallStack):
        pprPanic, called at compiler/GHC/Hs/Expr.hs:1817:27 in ghc-9.14.1-da80:GHC.Hs.Expr
...
/opt/ghc/9.14.1/bin/ghc -fno-code -v0  "$SCRIPT_DIR/test.hs"
```
...
| Label | ID | Source |
|-------|----|--------|
| `a` | `045685cc` | Project seed |
| `b` | `058b5935` | Project seed |
